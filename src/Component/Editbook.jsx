...
function EditBook() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (data) => {
            try {
                await axios.put(`https://62ab049e371180affbdf40f1.mockapi.io/Libstu/${params.id}`, data)
                alert("Edited Sucess'")
    ...
    let ComeData = async () => {
        try {
            let set = await axios.get(`https://62ab049e371180affbdf40f1.mockapi.io/Libstu/${params.id}`)
            formik.setValues({
